...
axios.interceptors.request.use(config => {
  ...
  newConfig = {
    ...
    headers: {
      post: {
        platformToken: sessionStorage.getItem(platformToken),
      },
      get: {
        platformToken: sessionStorage.getItem(platformToken),
      },
...
axios.interceptors.response.use(config => {
  BB = new Date();
  let start_date = moment(AA,"YYYY-MM-DD HH:mm:ss SSS");
  let end_date = moment(BB,"YYYY-MM-DD HH:mm:ss SSS");
  let seconds = end_date.diff(start_date,"millisecond");
  // console.log(config.config.url,seconds+'ms');
